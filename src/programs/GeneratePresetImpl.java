...
public class GeneratePresetImpl implements GeneratePreset {
    ...
    // Реализация алгоритма "хапуга". Не очень эффективный, но быстрый. Хотя в данном конкретном случае в аккурат подходит, видимо изначально заточено под такой метод
