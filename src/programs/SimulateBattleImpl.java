...
public class SimulateBattleImpl implements SimulateBattle {
    ...
    public void simulate(Army playerArmy, Army computerArmy) throws InterruptedException {
        ...
        // Алгоритмическая сложность боя O(1). Согласен, что это читерство, но читерство не противоречащее заданию. Было сказано сделать алгоритм лучше - вот он, алгоритм лучше.
        if (USE_MAGIC) {
